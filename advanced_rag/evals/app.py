...
# Force the use of the default asyncio event loop policy to avoid
# conflicts with uvloop, which is not patchable by nest_asyncio.
asyncio.set_event_loop_policy(asyncio.DefaultEventLoopPolicy())
nest_asyncio.apply()

# Fix for a known ragas <-> langchain-community import crash
# (ModuleNotFoundError: No module named 'langchain_community.chat_models.vertexai')
# This creates a dummy module to satisfy the import if it's missing.
try:
