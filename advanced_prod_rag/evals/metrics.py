...
# RAGAS imports ChatVertexAI eagerly even when this eval path uses Groq/OpenAI.
# Some langchain_community builds do not ship that module, so provide a tiny
# compatibility shim to keep the import path resolvable.
try:
